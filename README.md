...
express is a package that you download to use middleware, and lets you control endpoints in a url

- [x] Describe Middleware?
middleware is can let you react with axios call to send data back to the client 
...
by making folders to organize them 
